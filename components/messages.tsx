  ...
  return (
    <div className="relative flex-1 bg-background">
      ...
      <button
        ...
        className={`absolute bottom-4 left-1/2 z-10 -translate-x-1/2 cursor-pointer rounded-full border bg-background p-2 shadow-lg transition-all hover:bg-muted ${
          isAtBottom
