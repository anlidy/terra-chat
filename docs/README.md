...
| 设计与执行记录 | `docs/superpowers/` | 带日期的阶段性设计和计划，不代表已上线行为 |
...
| [`feat-rag`](../openspec/changes/feat-rag/proposal.md) | Needs review | 任务已勾选完成，但规格使用旧结构，当前 OpenSpec 校验失败；模块文档也需要复核 |
...
| 文档 | 状态 | 说明 |
| --- | --- | --- |
| [RAG Evaluation-First 设计](superpowers/specs/2026-07-19-rag-evaluation-first-design.md) | Implemented | 评测优先的 RAG 改进设计 |
| [RAG Evaluation-First 实施计划](superpowers/plans/2026-07-19-rag-evaluation-first.md) | Implemented | 对应设计的分步实施计划 |
